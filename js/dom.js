...
//evt.preventDefolt()-щоб в штмл-елемента прибрати нативну поведінку, ми про це фактично говоримо,що ми скидаємо базові налаштування.
//після цього при заповнення,наприклад форми, нічого не змінюється.Тобто скидає, прибирає дефолтне заначення.